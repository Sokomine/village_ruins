...
mg_villages.add_building( { scm="bunker",         mts_path=path, weight={ruins=1/9, single=1}, typ='bunker', orients={1}, yoff=-1});

mg_villages.add_building( { scm="wooden_house",   mts_path=path, weight={ruins=1,   single=1}, typ='shed',  orients={1}});
